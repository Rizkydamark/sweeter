...
MONGODB_CONNECTION_STRING = 'mongodb+srv://test:kaina24@cluster0.acicfe4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
    ...
    try:
        ...
        for post in posts:
            ...
            post["thumbsup_by_me"] = bool(
                db.likes.find_one(
                    {"post_id": post["_id"], "type": "thumsup", "username": payload["id"]}
                )
            )
        return jsonify(
            {
